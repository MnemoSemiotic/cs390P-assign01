...
class ProfessorsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create professor" do
    assert_difference('Professor.count') do
      post professors_url, params: { professor: { professorid: @professor.professorid, professorname: @professor.professorname } }
    end
  ...
  test "should update professor" do
    patch professor_url(@professor), params: { professor: { professorid: @professor.professorid, professorname: @professor.professorname } }
